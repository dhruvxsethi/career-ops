...
Interactive mode for when the candidate is filling out an application form in Chrome. Reads what's on screen, loads the prior offer context, and generates personalized answers for each form field.
...
- **Warn the candidate**: "The role changed from [X] to [Y]. Should I re-evaluate or adapt answers to the new title?"
...
5. **Visa/availability**: If asked about work authorization, note EP sponsorship requirement proactively
