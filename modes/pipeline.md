...
Processes offer URLs accumulated in `data/pipeline.md`. The user adds URLs whenever and then runs `/career-ops pipeline` to process them all.
...
- [ ] https://boards.greenhouse.io/company/jobs/456 | Company Inc | Senior ML Engineer
- [!] https://private.url/job — Error: login required

## Processed
- [x] #143 | https://jobs.example.com/posting/789 | Acme Corp | AI Platform Eng | 4.2/5 | PDF ✅
- [x] #144 | https://boards.greenhouse.io/xyz/jobs/012 | BigCo | AI Security | 2.1/5 | PDF ❌
```
...
- **`local:` prefix**: Read the local file. Example: `local:jds/govtech-ai-eng.md` → read `jds/govtech-ai-eng.md`

## Auto-numbering

1. List all files in `reports/`
2. Extract the number from the prefix (e.g. `142-grab-ai...` → 142)
