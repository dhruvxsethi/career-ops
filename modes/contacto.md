...
4. **Generate message** with 3-sentence framework adapted to contact type:
   ...
   - **Sentence 2 (Proof)**: Data point that answers their screening questions before they ask (e.g. "MS in AI at NTU, currently building production RAG pipelines at Palo Alto Networks, available from January 2027")
...
5. **Versions**:
   - EN (default)
   - If Singapore company with Chinese leadership — consider a brief Chinese greeting if candidate speaks Mandarin (not applicable for Dhruv, use EN)
