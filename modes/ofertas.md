...
| Estimated comp | 10% | 5=top quartile SG market, 1=below market |
| Growth trajectory | 10% | 5=clear path to next level, 1=dead end |
| Remote quality | 5% | 5=flexible hybrid SG, 3=full remote (outside SG ecosystem), 1=onsite only |
...
Ask the user for offers if not already in context. Can be text, URLs, or references to already-evaluated offers in the tracker.
